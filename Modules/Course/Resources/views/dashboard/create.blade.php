...
<div class="page-content-wrapper">
    <div class="page-content">
        ...
        <div class="row">
            <form id="form" role="form" class="form-horizontal form-row-seperated" method="post" enctype="multipart/form-data" action="{{route('dashboard.courses.store')}}">
                @csrf
                <div class="col-md-12">
                                ...
                                <div class="col-md-10">
                                    ...
                                    <div class="tab-content">
                                        ...
                                        <div class="tab-pane fade in {{ ($code == locale()) ? 'active' : '' }}" id="colored-rounded-tab-general-{{$code}}">
                                            ...
                                            <div class="form-group">
                                                <label class="col-md-2">
                                                    {{__('course::dashboard.courses.form.description')}}
                                                </label>
                                                <div class="col-md-9">
                                    ...
                                    {!! field()->file('image', __('course::dashboard.courses.form.image')) !!}
