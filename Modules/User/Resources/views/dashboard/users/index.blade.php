                        ...
                        <div class="portlet-body">
                            <table class="table table-striped table-bordered table-hover" id="dataTable">
                                ...
                                <tr>
                                    ...
                                    <th>#</th>
                                    <th class="hideInPrint">{{__('user::dashboard.users.datatable.image')}}</th>
                                    ...
                                    <th>{{__('user::dashboard.users.datatable.cv')}}</th>
                                    <th>{{__('user::dashboard.users.datatable.created_at')}}</th>
                                    <th class="hideInPrint">{{__('user::dashboard.users.datatable.options')}}</th>
                                </tr>
                                </thead>
                            </table>
                        </div>
            ...
            var dataTable =
                $('#dataTable').DataTable({
                    ...
                    columns: [
                        ...
                        {data: 'cv', className: 'dt-center', orderable: false},
                            ...
                            render: function (data, type, full, meta) {
                                ...
                                return `
                                    ...
                                    @permission('show_users')
                                        <a href="` + showUrl + `" class="btn btn-warning" title="Show">
                                        <i class="fa fa-eye"></i>
                                        </a>
                                    @endpermission
