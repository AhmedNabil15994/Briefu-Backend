                                        ...
                                        <ul class="nav nav-pills nav-stacked">
                                            ...
                                            <li>
                                                <a href="#subscription" data-toggle="tab">
                                                    {{ __('user::dashboard.users.update.form.subscription') }}
                                                </a>
                                            </li>
                                        </ul>
                                    </div>
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane active fade in" id="global_setting">
                                ...
                                <div class="col-md-10">
                                    ...
                                    {!! field()->file('image', __('user::dashboard.users.update.form.image'),$user->image ? url($user->image) : null) !!}
                                    <div class="form-group">
                                        <label class="col-md-2">
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-2">
                                            {{__('user::dashboard.users.create.form.is_special')}}
                                        </label>
                                        <div class="col-md-9">
                                            <input type="checkbox" class="make-switch" id="test" data-size="small"
                                                   name="is_special" {{($user->is_special == 1) ? ' checked="" ' : ''}}>
                                            <div class="help-block"></div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="tab-pane" id="subscription">
                                @include('user::dashboard.users.components.subscription')
                            </div>
                        </div>
                    </div>
