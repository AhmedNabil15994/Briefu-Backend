                        ...
                        <div class="portlet-body">
                            <table class="table table-striped table-bordered table-hover" id="dataTable">
                                ...
                                <tr>
                                    ...
                                    <th>#</th>
                                    <th class="hideInPrint">{{__('user::dashboard.admins.datatable.image')}}</th>
                                    ...
                                    <th class="hideInPrint">{{__('user::dashboard.admins.datatable.options')}}</th>
                                </tr>
                                </thead>
                            </table>
                        </div>
                        ...
                        {data: 'mobile', className: 'dt-center'},
                        {
                            ...
                            render: function (data, type, full, meta) {
                                ...
                                $.each(data, function( index, value ) {
                                    roles += '<label class="label label-success">'+value+'</label>';
                                });
                                return roles;
                            },
                        },
