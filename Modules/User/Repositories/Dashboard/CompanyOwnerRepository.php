    ...
    */
    public function create($request)
    {
        ...
        try {
            ...
            $image = $request['image'] ? Attachment::addAttachment($request['image'], 'companies/owners') : '/uploads/users/user.png';
    ...
    */
    public function update($request, $id)
    {
        ...
        try {
            ...
            $image = $request['image'] ? Attachment::updateAttachment($request['image'], $user->image, 'companies/owners') : $user->image;
