...
@section('title', __('job::dashboard.jobs.routes.update'))
@section('content')
    ...
    <div class="page-content">
        <div class="page-bar">
            <ul class="page-breadcrumb">
                ...
                <li>
                    <a href="#">{{__('job::dashboard.jobs.routes.update')}}</a>
                </li>
            </ul>
        </div>
        ...
        <div class="row">
            <form id="updateForm" page="form" class="form-horizontal form-row-seperated" method="post" enctype="multipart/form-data" action="{{route('dashboard.jobs.update',$job->id)}}">
                @csrf
                @method('PUT')
                <div class="col-md-12">
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane active fade in" id="global_setting">
                                ...
                                <div class="col-md-10">
                                    ...
                                    <div class="tab-content">
                                        ...
                                        <div class="tab-pane fade in {{ ($code == locale()) ? 'active' : '' }}" id="colored-rounded-tab-general-{{$code}}">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <input type="text" name="title[{{$code}}]" class="form-control" data-name="title.{{$code}}" value="{{ $job->translate($code)->title }}" {{ (is_rtl($code) == 'rtl') ? 'dir=rtl' : '' }}>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <textarea name="description[{{$code}}]" rows="8" cols="80" class="form-control {{is_rtl($code)}}Editor" data-name="description.{{$code}}">{{ $job->translate($code)->description }}</textarea>
                                                    <div class="help-block"></div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    pluckModelsCols($cities->get(),'id','title',false,true),$job->cities->pluck('id')->toArray()) !!}
                                        ...
                                        <div class="col-md-9">
                                            <select name="categories[]" class="form-control select2" data-name="categories" multiple>
                                                ...
                                                @foreach ($categories as $category)
                                                    <option value="{{ $category['id'] }}" {{ $job->categories->contains($category['id']) ? 'selected' : '' }}>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <input type="checkbox" class="make-switch" id="test" data-size="small" name="subscription_access" {{($job->subscription_access == 1) ? ' checked="" ' : ''}}>
                                            <div class="help-block"></div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <input type="checkbox" class="make-switch" id="test" data-size="small" name="status" {{($job->status == 1) ? ' checked="" ' : ''}}>
                                            <div class="help-block"></div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-2">
                                            {{__('job::dashboard.jobs.form.restore')}}
                                        </label>
                                        <div class="col-md-9">
                                            ...
                                            <div class="col-md-9">
                                                <select name="attribute_values[]" class="form-control select2" data-name="attribute_values[]">
                                                    ...
                                                    @foreach ($attribute->values as $value)
                                                        <option value="{{ $value['id'] }}" {{ $job->attributes->contains($value['id']) ? 'selected' : '' }}>
