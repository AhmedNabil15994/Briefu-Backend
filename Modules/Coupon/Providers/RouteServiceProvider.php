...
{
    protected $apiModule       = '\Modules\Coupon\Http\Controllers\WebService';
    ...
    protected function mapApiRoutes()
    {
        Route::group(['prefix'=>'api' ,'middleware' => ['api'] , 'namespace' => $this->apiModule],function() {
            ...
            if (File::allFiles(module_path('Coupon', 'Routes/WebService'))) {
                foreach (File::allFiles(module_path('Coupon', 'Routes/WebService')) as $file) {
                    require_once($file->getPathname());
                }
            }
