...
<body>
        ...
        <table class="table" style="width: 100%">
            <thead>
                <tr>
                    <td width="30%">
                        <center>
                            <img src="{{setting('favicon')}}" style="height: 100px;">
    ...
    <htmlpagefooter name="page-footer" style="width:100%">
        <span style="float: {{locale() == 'en' ? 'left' : 'right'}}">{{\Carbon\Carbon::now()->toDateString()}}</span>
        <span style="float: {{locale() == 'ar' ? 'left' : 'right'}}"> / {PAGENO}</span>
    </htmlpagefooter>
</body>
</html>
