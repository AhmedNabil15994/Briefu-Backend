        ...
        <div class="row">
            <div class="col-md-12">
                <div class="portlet light bordered">
                        ...
                        <table class="table table-striped table-bordered table-hover" id="dataTable">
                            <thead>
                                <tr>
                                    ...
                                    <th>#</th>
                                    <th class="hideInPrint">{{__('company::dashboard.companies.datatable.image')}}</th>
                                    <th>{{__('company::dashboard.companies.datatable.status')}}</th>
                                    <th>{{__('company::dashboard.companies.datatable.title')}}</th>
                                    <th>{{__('company::dashboard.companies.datatable.created_at')}}</th>
                                    <th class="hideInPrint">{{__('company::dashboard.companies.datatable.options')}}</th>
                                </tr>
                            </thead>
                        </table>
                    </div>
                    <div class="row">
                        <div class="form-group">
                            <button type="submit" id="deleteChecked" class="btn red btn-sm" onclick="deleteAllChecked('{{ url(route('dashboard.companies.deletes')) }}')">
