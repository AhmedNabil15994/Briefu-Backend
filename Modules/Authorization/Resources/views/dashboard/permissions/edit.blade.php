        ...
        <div class="page-content">
            ...
            <div class="row">
                <form id="updateForm" role="form" class="form-horizontal form-row-seperated" method="post"
                      enctype="multipart/form-data" action="{{route('dashboard.permissions.update',$permission->id)}}">
                    @csrf
                    @method('PUT')
                    <div class="col-md-12">
                        <div class="col-md-3">
                                ...
                                <div class="tab-pane active fade in" id="general">
                                    ...
                                    <div class="col-md-10">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <input type="text" name="display_name[{{$code}}]"
                                                           ...
                                                           value="{{ $permission->getTranslation('display_name',$code) }}">
                                                    <div class="help-block"></div>
                                                </div>
                                            </div>
                                        @endforeach
                                        @foreach (config('translatable.locales') as $code)
                                            <div class="form-group">
                                                <label class="col-md-2">
                                                    {{__('authorization::dashboard.permissions.form.description')}}
                                                    - {{ $code }}
                                                </label>
                                                <div class="col-md-9">
                                                    <textarea name="description[{{$code}}]" rows="8" cols="80"
                                                              class="form-control"
                                                              data-name="description.{{$code}}">{{ $permission->getTranslation('description',$code)}}</textarea>
                                                    <div class="help-block"></div>
                                                </div>
                                            </div>
                                        @endforeach
