                            ...
                            <div class="tab-pane active fade in" id="general">
                                ...
                                <div class="col-md-10">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" name="display_name[{{$code}}]" placeholder="users" class="form-control" data-name="display_name" value="{{ $role->display_name }}">
                                            <div class="help-block"></div>
                                        </div>
                                    </div>
                                    @endforeach
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <textarea name="description[{{$code}}]" rows="8" cols="80" class="form-control" data-name="description.{{$code}}">{{ $role->description }}</textarea>
                                            <div class="help-block"></div>
                                        </div>
                                    </div>
                                    @endforeach
